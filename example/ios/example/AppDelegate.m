...
RCT_EXPORT_METHOD(pushVC:(NSString *)vcName){
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    NSBundle* bundle = [NSBundle bundleForClass:ctrlClass];
    NSURL* bundleURL = [bundle.resourceURL URLByAppendingPathComponent:@"sz-native.bundle"];
...
//    TestViewController *newVc = [[ctrlClass alloc] initWithNibName:vcName bundle:resourceBundle];
////    [newVc setRTCBridge:self.bridge];
